class Turtle {
    ...
    clone() {
        return new Turtle(this.emoji, this.positionX, this.positionY, this.angle, this.speed, !!this.turtlespan, this.canvas);
    }
    hide() {
        if (!this.turtlespan)
            return;
...
export class TurtleManager {
    ...
    height;
    ctx;
    constructor(selector, dpr = window.devicePixelRatio || 1) {
